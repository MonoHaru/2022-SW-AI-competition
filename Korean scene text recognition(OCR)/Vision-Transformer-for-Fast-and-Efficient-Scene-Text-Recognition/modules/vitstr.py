...
from timm.models.beit import Beit, _cfg
...
__all__ = [
    ...
    'vitstr_deit3_large_patch16_224_in21ft1k',
    'vitstr_deit3_large_patch16_384',
    'vitstr_beit_large_patch16_384',
    'vitstr_beit_large_patch16_224',
    'vitstr_beitv2_large_patch16_224',
...
@register_model
def vitstr_deit3_large_patch16_224_in21ft1k(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR(
        patch_size=16, embed_dim=1024, depth=24, num_heads=16, qkv_bias=True, **kwargs)
    model.default_cfg = _cfg(
            #url='https://github.com/roatienza/public/releases/download/v0.1-deit-base/deit_base_patch16_224-b5f2ef4d.pth'
...
@register_model
def vitstr_deit3_large_patch16_384(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR(
        img_size=384, patch_size=16, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4, qkv_bias=True, **kwargs)
    model.default_cfg = _cfg(
            #url='https://github.com/roatienza/public/releases/download/v0.1-deit-base/deit_base_patch16_224-b5f2ef4d.pth'
...
@register_model
def vitstr_beit_large_patch16_384(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR_beit(
        img_size=384, patch_size=16, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4, qkv_bias=True, **kwargs)
    model.default_cfg = _cfg(
...
@register_model
def vitstr_beit_large_patch16_224(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR_beit(
...
@register_model
def vitstr_beitv2_large_patch16_224(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR_beit(
        patch_size=16, embed_dim=1024, depth=24, num_heads=16, mlp_ratio=4, qkv_bias=True, **kwargs)
    model.default_cfg = _cfg(
